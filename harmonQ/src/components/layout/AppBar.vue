    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-2">
      <div class="flex">
        ...
        <a href="#" class="flex items-center">
          <img src="/erplogorenkli.png" class="h-10 mr-3" alt="erp Logo" />
        </a>
      </div>
      <button
